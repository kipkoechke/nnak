...
export default function FinanceByproductUploadPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    router.push(
      created.id ? `/nnak/finance/byproducts/${created.id}` : "/nnak/finance/byproducts",
    );
  };
  ...
  return (
    <div className="px-4 py-4 flex flex-col gap-3">
      <PageHeader
        ...
        back={() => router.push("/nnak/finance/byproducts")}
        action={
          <button
      ...
      >
        ...
        <div className="flex justify-end gap-2 mt-5">
          <button
            type="button"
            onClick={() => router.push("/nnak/finance/byproducts")}
