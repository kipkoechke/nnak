...
import type { ByProductUploadRecord } from "@/types/nnak";
...
/**
 * Shared by-product upload detail view. Admin and finance read from different
 * endpoints but present the same thing, so both routes render this.
 */
export default function UploadDetail({
  ...
  upload?: ByProductUploadRecord | null;
  isLoading?: boolean;
  onBack: () => void;
}) {
